...
Route::controller(FeedbackController::class)->group(function () {
    Route::get('/create-feedback', 'create')->name('feedback.create');
    Route::post('/save-feedback', 'save')->name('feedback.save');
});
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function () {
    ...
    Route::controller(HomeController::class)->group(function () {
        ...
        Route::get('/new-customer-login', 'newCustomerLogin')->name('user.new-customer-login');
    });
...
Route::get('shops/get_state/{country}', [ShopController::class, 'get_state'])->name('register.get_state');
Route::get('shops/get_cities/{state}', [ShopController::class, 'get_cities'])->name('register.get_cities');
Route::post('shops/store-shop', [ShopController::class, 'store_shop'])->name('shops.store-shop');
