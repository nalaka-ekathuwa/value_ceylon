...
use App\Http\Controllers\Seller\RFQReplyController;
...
Route::group(['prefix' => 'seller'], function () {
    ...
    Route::group(['middleware' => ['seller', 'user', 'prevent-back-history',]], function () {
        ...
        Route::get('/create-step-3', [SellerCreateController::class, 'stepThree'])->name('seller.create-step-3');
        Route::post('/create-step-3/submit', [SellerCreateController::class, 'stepThreeSubmit'])->name('seller.create-step-3.submit');

        Route::get('/create-step-4', [SellerCreateController::class, 'stepFour'])->name('seller.create-step-4');
        Route::post('/create-step-4/submit', [SellerCreateController::class, 'stepFourSubmit'])->name('seller.create-step-4.submit');
    });
});


Route::group(['namespace' => 'App\Http\Controllers\Seller', 'prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user', 'handle-seller-registration', 'prevent-back-history'], 'as' => 'seller.'], function () {
    ...
    Route::controller(RFQController::class)->group(function () {
        Route::get('/rfqs', 'index')->name('rfqs.index');
        Route::get('/rfqs/{rfq}', 'show')->name('rfqs.show');
        Route::post('/rfqs/{rfq}', 'save')->name('rfqs.save');
        Route::get('/rfqs/{rfq}/edit', 'edit')->name('rfqs.edit');
    });

    Route::controller(RFQReplyController::class)->group(function (): void {
        Route::get('/replied-rfqs', 'index')->name('rfqs.replies.index');
        Route::get('/rfqs/{rfq}/replies', 'show')->name('rfqs.replies.show');
