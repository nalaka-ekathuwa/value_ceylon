...
<div class="row">
        ...
        <form action="{{ route('seller.ads.store') }}" method="POST" id="ad-create-form">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h6 class="mb-0"><i class="las la-map-marker-alt mr-1"></i> {{ translate('Placement & Position') }}</h6>
                </div>
                <div class="card-body">
                    <div class="form-group row mb-3">
                        <label class="col-sm-3 control-label">{{ translate('Page / Placement') }} <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row mb-3" id="position-wrap" style="display:none!important;">
                        <label class="col-sm-3 control-label">{{ translate('Ad Position') }} <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="form-group row mb-3">
                        <label class="col-sm-3 control-label">{{ translate('Ad Type') }} <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row mb-3">
                        <label class="col-sm-3 control-label">{{ translate('Upload Media') }} <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                            ...
                            <small class="text-muted" id="media-hint">{{ translate('Upload the ad banner image.') }}</small>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select name="product_id" id="product_id" class="form-control aiz-selectpicker" data-live-search="true">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="form-group row mb-3">
                        <label class="col-sm-3 control-label">{{ translate('Start Date') }} <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row mb-3">
                        <label class="col-sm-3 control-label">{{ translate('End Date') }} <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
    ...
    <div class="col-lg-4">
        <div class="card bg-soft-info mb-3">
            <div class="card-body">
                <h6 class="font-weight-bold mb-3"><i class="las la-info-circle mr-1"></i> {{ translate('Ad Placements') }}</h6>
        ...
        <div class="card bg-soft-warning">
            <div class="card-body">
                <h6 class="font-weight-bold mb-2"><i class="las la-exclamation-triangle mr-1"></i> {{ translate('Important Notes') }}</h6>
