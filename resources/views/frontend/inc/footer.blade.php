...
@if (get_setting('footer_title') != null || get_setting('footer_description') != null)
    <section class="bg-white border-top mt-auto py-4 py-md-5 footer-seo-section position-relative overflow-hidden">
        <div class="container">
            <div class="p-4 p-md-5 rounded-lg border position-relative shadow-sm"
                style="background: linear-gradient(135deg, rgba(27, 108, 168, 0.08) 0%, rgba(255, 255, 255, 0.95) 100%); border-color: rgba(27, 108, 168, 0.15) !important;">
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="d-flex align-items-center mb-3">
                            <span
                                class="avatar avatar-sm text-white mr-3 flex-shrink-0 d-inline-flex align-items-center justify-content-center rounded-circle"
                                style="width: 40px; height: 40px; background-color: #1b6ca8;">
                                <i class="las la-clinic-medical fs-20"></i>
                            </span>
                            <h1 class="fs-18 fs-md-22 fw-700 mb-0" style="color: #1b6ca8;">
    ...
    <div class="container">
        ...
        {{-- <div class="mt-3 mb-4">
            <a href="{{ route('home') }}" class="d-block">
                ...
                <img class="lazyload h-45px" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                    data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" height="45">
                @else
                <img class="lazyload h-45px" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
        ...
        <div class="row">
            ...
            {{-- <div class=" col-lg-12">
                ...
                <h5 class="fs-14 fw-700 text-soft-light mt-1 mb-3">{{ translate('Subscribe to our newsletter for regular
                ...
                <div class="mb-3">
                    <form method="POST" action="{{ route('subscribers.store') }}">
                        ...
                        <div class="row gutters-10">
                            <div class="col-8">
                                <input type="email" class="form-control border-white rounded-0  w-100 bg-transparent"
                                    placeholder="{{ translate('Your Email Address') }}" name="email" required>
                            </div>
                            <div class="col-4">
                                <button type="submit" class="btn btn-primary rounded-0 w-100">{{ translate('Subscribe')
                                    }}</button>
                            </div>
                        </div>
                    </form>
            ...
            <div class="col-sm-6 col-lg-6 mb-3 mb-sm-0">
                ...
                @if (get_setting('show_social_links'))
                    <h5 class="fs-14 fw-700 text-uppercase mt-2 mb-3 text-center text-sm-left">
                        {{ translate('Follow Us On') }}</h5>
                    <ul
                        class="list-inline social colored mb-0 d-flex flex-wrap justify-content-center justify-content-sm-start align-items-center">
                        @if (!empty(get_setting('facebook_link')))
                            <li class="list-inline-item mx-2 ml-sm-0 mr-sm-3 mb-2">
                        ...
                        @if (!empty(get_setting('instagram_link')))
                            <li class="list-inline-item mx-2 mr-sm-3 mb-2">
                        ...
                        <li class="list-inline-item mx-2 mr-sm-3 mb-2">
                            <a href="#" target="_blank"
                                class="twitter d-inline-flex align-items-center justify-content-center"><svg fill="#fff"
            ...
            <div class="col-sm-6 col-lg-6">
                ...
                @if((get_setting('play_store_link') != null) || (get_setting('app_store_link') != null))
                    <h5 class="fs-14 fw-700 text-uppercase mt-2 mb-3 text-center text-sm-right">
                        {{ translate('Mobile Apps') }}</h5>
                    <div class="d-flex flex-wrap justify-content-center justify-content-sm-end align-items-center">
                        <div class="mb-2 mr-2">
...
@endphp
<section class="py-3 py-lg-4 footer-widget">
    <!-- footer widgets -->
    <div class="container d-none d-md-block">
        <div class="row">
            <!-- Quick links -->
            <div class="col-md-6 col-lg-3">
                <div class="text-left mt-3 mt-lg-4">
                    <h4 class="fs-14 text-uppercase fw-700 mb-3 border-bottom pb-2 border-light-gray d-inline-block">
                        {{ translate('Useful Links') }}</h4>
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <p class="fs-14 mb-1">
                                <a href="{{ route('about-value-ceylon') }}"
                                    class="text-reset opacity-80 hov-opacity-100">About Us</a>
                            </p>
                        </li>
                        <li class="mb-2">
                            <p class="fs-14 mb-1">
                                <a href="{{ route('contact-us') }}"
                                    class="text-reset opacity-80 hov-opacity-100">Contact us</a>
                            </p>
                        </li>
                        <li class="mb-2">
                            <p class="fs-14 mb-1">
                        ...
                        <li class="mb-2">
                            <p class="fs-14 mb-1">
                                <a href="{{ route('our_services') }}" class="text-reset opacity-80 hov-opacity-100">Our
                                    Services</a>
                            </p>
                        </li>
                    </ul>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="text-left mt-3 mt-lg-4">
                    <h4 class="fs-14 text-uppercase fw-700 mb-3 border-bottom pb-2 border-light-gray d-inline-block">
                        {{ translate('Help & Support') }}</h4>
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <p class="fs-14 mb-1">
                                <a href="{{ route('faq') }}" class="text-reset opacity-80 hov-opacity-100">Frequently
                                    Asked Questions</a>
                            </p>
                        </li>
                        <li class="mb-2">
                            <p class="fs-14 mb-1">
                                <a href="{{ route('faq_seller') }}" class="text-reset opacity-80 hov-opacity-100">Seller
                                    Support</a>
                            </p>
                        </li>
                        <li class="mb-2">
                            <p class="fs-14 mb-1">
                                <a href="{{ route('faq_customer') }}"
                                    class="text-reset opacity-80 hov-opacity-100">Customer Support</a>
                            </p>
                        </li>
                        <li class="mb-2">
                            <p class="fs-14 mb-1">
                                <a href="{{ route('faq_special') }}"
                                    class="text-reset opacity-80 hov-opacity-100">Special Features</a>
                            </p>
                        </li>
                        <li class="mb-2">
                            <p class="fs-14 mb-1">
                                <a href="/sitemap.xml" target="_blank"
                                    class="text-reset opacity-80 hov-opacity-100">Sitemap</a>
                            </p>
                        </li>
                    </ul>
                </div>
                        ...
                        <li class="mb-2">
                            <p class="fs-14 mb-1">
                                <a href="{{ route('seller.create-step-1') }}"
                                    class="text-reset opacity-80 hov-opacity-100">Sell on valueceylon.com</a>
                            </p>
                        </li>
                        <li class="mb-2">
                            <p class="fs-14 mb-1">
                                <a href="{{ route('blog') }}?search=&selected_categories%5B%5D=Seller-Knowledge-base"
            ...
            <div class="col-md-6 col-lg-3">
                <div class="text-left mt-3 mt-lg-4">
                    <h4 class="fs-14 text-uppercase fw-700 mb-3 border-bottom pb-2 border-light-gray d-inline-block">
                        {{ translate('Buyer Zone') }}</h4>
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <p class="fs-14 mb-1">
                                <a href="{{ route('customer.request-for-quotation') }}"
                                    class="text-reset opacity-80 hov-opacity-100">Value Ceylon Sourcing</a>
                            </p>
                        </li>
                        <li class="mb-2">
                            <p class="fs-14 mb-1">
                                <a href="{{ route('blog') }}?search=&selected_categories%5B%5D=Buyer-Knowledge-Base"
                                    class="text-reset opacity-80 hov-opacity-100">Buyer Knowledge Base</a>
                            </p>
                        </li>
                        <li class="mb-2">
                            <p class="fs-14 mb-1">
    ...
    <div class="d-md-none bg-transparent">
        <!-- Quick links -->
        <div class="aiz-accordion-wrap bg-black">
            <div class="aiz-accordion-heading container bg-black">
                <button
                    class="aiz-accordion fs-14 bg-transparent text-white fw-600">{{ get_setting('widget_one', null, App::getLocale()) }}</button>
            </div>
                            ...
                            @foreach (json_decode(get_setting('widget_one_labels', null, App::getLocale()), true) as $key => $value)
                                ...
                                <li class="mb-2 pb-2 @if (url()->current() == $widget_one_links) active @endif">
                                    <a href="{{ $widget_one_links }}"
                                        class="fs-13 text-white opacity-80 animate-underline-white">
                                        {{ $value }}
                                    </a>
                                </li>
                            @endforeach
        ...
        <div class="aiz-accordion-wrap bg-black">
            <div class="aiz-accordion-heading container bg-black">
                <button class="aiz-accordion fs-14 bg-transparent text-white fw-600">{{ translate('Contacts') }}</button>
            </div>
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #212129 !important;">
                <div class="container">
                    <ul class="list-unstyled mt-3">
                        <li class="mb-2">
                            <p class="fs-13 text-white fw-600 mb-1">{{ translate('Address') }}</p>
                            <p class="fs-13 text-white opacity-80">{{ get_setting('contact_address', null, App::getLocale()) }}
                            </p>
                        </li>
                        <li class="mb-2">
                            <p class="fs-13 text-white fw-600 mb-1">{{ translate('Phone') }}</p>
                            <p class="fs-13 text-white opacity-80">{{ get_setting('contact_phone') }}</p>
                        </li>
                        <li class="mb-2">
                            <p class="fs-13 text-white fw-600 mb-1">{{ translate('Email') }}</p>
                            <p class="">
                                <a href="mailto:{{ get_setting('contact_email') }}"
                                    class="fs-13 text-white opacity-80 hov-text-primary">{{ get_setting('contact_email')  }}</a>
                            </p>
                        </li>
                    </ul>
                </div>
        ...
        <div class="aiz-accordion-wrap bg-black">
            <div class="aiz-accordion-heading container bg-black">
                <button class="aiz-accordion fs-14 bg-transparent text-white fw-600">{{ translate('My Account') }}</button>
            </div>
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #212129 !important;">
                <div class="container">
                    <ul class="list-unstyled mt-3">
                        @auth
                            <li class="mb-2 pb-2">
                                <a class="fs-13 text-white opacity-80 animate-underline-white"
                                    href="{{ route('logout') }}">
                                    {{ translate('Logout') }}
                                </a>
                            </li>
        ...
        @if (get_setting('vendor_system_activation') == 1)
            <div class="aiz-accordion-wrap bg-black">
                <div class="aiz-accordion-heading container bg-black">
                    <button class="aiz-accordion fs-14 bg-transparent text-white fw-600">{{ translate('Seller Zone') }}</button>
                </div>
                <div class="aiz-accordion-panel bg-transparent" style="background-color: #212129 !important;">
                    <div class="container">
                        <ul class="list-unstyled mt-3">
                            <li class="mb-2 pb-2 {{ areActiveRoutes(['shops.create'], ' active')}}">
                                <p class="fs-13 text-white opacity-80 mb-0">
                                    {{ translate('Become A Seller') }}
                                    <a href="{{ route('shops.create') }}"
                                        class="fs-13 fw-700 text-primary ml-2">{{ translate('Apply Now') }}</a>
                                </p>
                            </li>
                            @guest
                            ...
                            @if(get_setting('seller_app_link'))
                                <li class="mb-2 pb-2">
                                    <a class="fs-13 text-white opacity-80 animate-underline-white" target="_blank"
        ...
        @if (addon_is_activated('delivery_boy'))
            <div class="aiz-accordion-wrap bg-black">
                <div class="aiz-accordion-heading container bg-black">
                    <button class="aiz-accordion fs-14 bg-transparent text-white fw-600">{{ translate('Delivery Boy') }}</button>
                </div>
                <div class="aiz-accordion-panel bg-transparent" style="background-color: #212129 !important;">
                    <div class="container">
                        <ul class="list-unstyled mt-3">
...
<!-- FOOTER -->
<footer class="pt-3 pb-8 pb-xl-3">
    <div class="container">
        <div class="row align-items-center py-2">
            <!-- Copyright -->
            <div class="col-lg-6 order-1 order-lg-0">
                <div class="text-center text-lg-left fs-13" current-verison="{{get_setting("current_version")}}">
                    ...
                    <ul class="list-inline mb-0">
                        @if (get_setting('payment_method_images') != null)
                            @foreach (explode(',', get_setting('payment_method_images')) as $key => $value)
                                <li class="list-inline-item mx-1 mr-sm-2 mb-1">
                                    <img src="{{ uploaded_asset($value) }}" height="28" class="mw-100 h-auto"
                                        style="max-height: 28px" alt="{{ translate('payment_method') }}">
                                </li>
                            @endforeach
                        @endif
                    </ul>
...
<div class="aiz-mobile-bottom-nav d-xl-none fixed-bottom border-top border-sm-bottom border-sm-left border-sm-right mx-auto mb-sm-2"
    ...
    <div class="row align-items-center gutters-5">
        ...
        <div class="col">
            <a href="{{ route('home') }}"
                class=" d-block text-center pb-2 pt-3 {{ areActiveRoutes(['home'], 'svg-active')}}">
        ...
        <div class="col">
            <a href="{{ route('categories.all') }}"
                class=" d-block text-center pb-2 pt-3 {{ areActiveRoutes(['categories.all'], 'svg-active')}}">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
        ...
        <div class="col-auto">
            <a href="{{ route('cart') }}"
                class=" d-block text-center pb-2 pt-3 px-3 {{ areActiveRoutes(['cart'], 'svg-active')}}">
                <span class="d-inline-block position-relative px-2">
                    <svg id="Group_25499" data-name="Group 25499" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" width="16.001" height="16" viewBox="0 0 16.001 16">
                        <defs>
        ...
        <div class="col">
            <a href="{{ route('all-notifications') }}"
                class=" d-block text-center pb-2 pt-3 {{ areActiveRoutes(['all-notifications'], 'svg-active')}}">
                <span class="d-inline-block position-relative px-2">
        ...
        <div class="col">
            @if (Auth::check())
                ...
                @else
                    <a href="javascript:void(0)" class=" d-block text-center pb-2 pt-3 mobile-side-nav-thumb"
