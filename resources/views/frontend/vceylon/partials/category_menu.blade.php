<div class="aiz-category-menu bg-white rounded-0 border-top" id="category-sidebar" style="width:270px; height: 553px;
overflow: scroll;">
        ...
        @foreach (get_level_zero_categories()->take(50) as $key => $category)
            ...
            <li class="category-nav-element  border-top-0" data-id="{{ $category->id }}">
                <a href="{{ route('products.category', $category->slug) }}"
                    class="text-truncate px-4 fs-14 d-block hov-column-gap-1 bg-gray-200 text-black">
