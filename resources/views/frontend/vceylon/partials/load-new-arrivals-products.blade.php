<div class="d-flex my-5 mb-2 mb-md-3 align-items-baseline justify-content-between bg-primary text-white p-3">
    ...
    <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
        <span class="pb-3">New Arrivals </span>
    </h3>
</div>

@if (count($products) > 0)

    <div class="row my-5 new-arrivals-products-slider">
        ...
        <div class="">
            <div class="aiz-card-box h-auto bg-white py-3 hov-scale-img px-3">
                <div class="position-relative img-fit overflow-hidden">
                    ...
                    <!-- Dummy product URL -->
                    <a href="/product/dummy-product" class="d-block h-100">
                        <img class="lazyload mx-auto img-fit has-transition"
                    ...
                    <!-- Wholesale tag -->
                    <span class="absolute-top-left fs-11 text-white fw-700 px-2 lh-1-8 ml-1 mt-1"
                        style="background-color: #455a64; top:25px;">
                        Wholesale
                    </span>
                    ...
                    <div class="absolute-top-right aiz-p-hov-icon">
                        <a href="javascript:void(0)" class="hov-svg-white"
                        onclick="alert('Wishlist clicked')" data-toggle="tooltip"
                        data-title="Add to wishlist" data-placement="left">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14.4"
                                viewBox="0 0 16 14.4">
                                <g transform="translate(-3.05 -4.178)">
                                    <path d="M11.3,5.507l-.247.246L10.8,5.506A4.538,4.538,0,1,0,4.38,11.919l.247.247,
                                    6.422,6.412,6.422-6.412.247-.247A4.538,4.538,0,1,0,11.3,5.507Z"
                                        fill="#919199" />
                                </g>
                            </svg>
                        </a>
                    ...
                    <!-- Add to Cart button -->
                    <a class="cart-btn absolute-bottom-left w-100 h-35px aiz-p-hov-icon text-white fs-13 fw-700
                            d-flex flex-column justify-content-center align-items-center"
                    href="javascript:void(0)" onclick="alert('Add to cart')">
                ...
                <div class="p-2 p-md-3 text-left">
                    <!-- Product name -->
                    <h3 class="fw-400 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px text-center">
                        <a href="/product/dummy-product"
                        class="d-block text-reset hov-text-primary"
                        title="Dummy Product Name">
                            Dummy Product Name Goes Here
                        </a>
                    </h3>
                    ...
                    <div class="fs-14 d-flex justify-content-center mt-3">
                        ...
                        <!-- Previous price -->
                        <div class="disc-amount has-transition">
                            <del class="fw-400 text-secondary mr-1">$120.00</del>
                        </div>
