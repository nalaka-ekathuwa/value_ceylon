                        ...
                        <div class="text-left">
                                ...
                                <div class="col-sm-10">
                                    <div class="">
                                        ...
                                        @if ($customer_product->unit != null || $customer_product->unit != '')
                                            <span
                                                class="opacity-70 ml-1">/{{ $customer_product->getTranslation('unit') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="list-group rounded mt-5">
                                <li class="list-group-item">
                                    <div class="d-flex">
                                        <span
                                            class="d-flex align-items-center justify-content-center rounded-circle size-30px bg-soft-secondary mr-2">
                ...
                <div class="tab-content pt-0">
                    ...
                    <div class="tab-pane" id="tab_default_3">
                        <div class="p-4 text-center ">
                            <a href="{{ uploaded_asset($customer_product->pdf) }}"
        ...
        <div class="container">
            <div class="bg-white border p-4">
                <div class="d-flex mb-3 align-items-baseline border-bottom py-3">
                    ...
                    <a class="ml-auto mr-0 text-blue fs-12 fw-700 hov-text-primary"
                        href="{{ route('customer_products.category', $customer_product->category->slug) }}">{{ translate('View More') }}</a>
                </div>
                <div class="p-3">
                    <div class="aiz-carousel gutters-16 half-outside-arrow" data-items="6" data-xl-items="5"
                        ...
                        @foreach ($products as $key => $product)
                            <div
                                class="carousel-box overflow-hidden has-transition hov-shadow-out z-1 border-right border-top border-bottom @if ($key == 0) border-left @endif">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <div class="absolute-top-left">
                                            @if ($product->conditon == 'new')
                                                <span class="badge badge-inline badge-info fs-13 fw-700 p-3 text-white"
                                                    style="border-radius: 20px;">{{ translate('New') }}</span>
                                            @elseif($product->conditon == 'used')
                                                <span class="badge badge-inline badge-secondary-base fs-13 fw-700 p-3 text-white"
                                            style="border-radius: 20px;">{{ translate('Used') }}</span> @endif
                                        </div>
                                    </div>
