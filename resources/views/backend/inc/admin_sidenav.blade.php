            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @canany(['add_new_product', 'show_all_products', 'show_in_house_products', 'show_seller_products',
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Products management system') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <!--Submenu-->
                        <ul class="aiz-side-nav-list level-2">
                ...
                @canany(['view_all_orders', 'view_inhouse_orders', 'view_seller_orders', 'view_pickup_point_orders'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Order management system') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <!--Submenu-->
                        <ul class="aiz-side-nav-list level-2">
                ...
                @canany(['view_blogs', 'view_blog_categories'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Content management system') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            @can('view_blogs')
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{ translate('Advertising management system') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('advertising.index') }}" class="aiz-side-nav-link ">
                                <span class="aiz-side-nav-text">{{ translate('All banners') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('advertising.create') }}" class="aiz-side-nav-link ">
                ...
                @canany(['view_all_flash_deals', 'send_newsletter', 'send_bulk_sms', 'view_all_subscribers',
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Marketing Management system') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                    ...
                    @canany(['view_all_seller', 'seller_payment_history', 'view_seller_payout_requests',
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                ...
                                <span class="aiz-side-nav-text">{{ translate('Merchant Management System') }}</span>
                                <span class="aiz-side-nav-arrow"></span>
                            </a>
                            <ul class="aiz-side-nav-list level-2">
                                @can('view_all_seller')
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('admin.rfq.index') }}" class="aiz-side-nav-link">
                                        <span
                                            class="aiz-side-nav-text">{{ translate('RFQ List') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                ...
                @canany(['view_all_staffs', 'view_staff_roles'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Staff management System') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            @can('view_all_staffs')
                ...
                @canany(['view_all_customers', 'view_classified_products', 'view_classified_packages'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Customer management system') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <div class="aiz-side-nav-icon">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    stroke="#575b6a" stroke-linejoin="round" />
                                <path
                        ...
                        <span class="aiz-side-nav-text">Notification Management System </span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.feedbacks.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Feedbacks') }}</span>
                            </a>
                        </li>
                ...
                @canany(['in_house_product_sale_report', 'seller_products_sale_report', 'products_stock_report',
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Accounting management System') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <g id="Group_28292" data-name="Group 28292" transform="translate(-1.25 -1.25)">
                                            <g id="Group_28290" data-name="Group 28290"
                                                transform="translate(1.25 9.644)">
                                            ...
                                            <g id="Group_28291" data-name="Group 28291"
                                                transform="translate(5.042 2.545)">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('paytm.index') }}" class="aiz-side-nav-link">
                                    <span
                                        class="aiz-side-nav-text">{{ translate('Set Asian PG Credentials') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                                ...
                                <div class="aiz-side-nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <g id="Group_28295" data-name="Group 28295"
                                            transform="translate(-19275 2615)">
                                ...
                                <div class="aiz-side-nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <g id="Group_28317" data-name="Group 28317"
                                            transform="translate(-19315.001 1976)">
