...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h1 class="h3">{{ translate('Category Slot Availability') }}</h1>
        </div>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header border-bottom-0">
                <h5 class="mb-0 h6">{{ translate('Parent Category Slot Availability (Today)') }}</h5>
            </div>
            <div class="card-body p-3">
                    ...
                    <tbody>
                        @foreach($parentCategories as $cat)
                            @php
                                ...
                                $cat_id = $cat->id;
                                $sub_id = null;
                                $display_name = $cat->getTranslation('name');
                            ...
                            <tr>
                                <td>
                                    ...
                                    <span class="badge badge-inline badge-soft-primary ml-2">{{ translate('Parent') }}</span>
                                </td>
                ...
                <div class="text-center py-4">
                    <p class="text-muted">{{ translate('No parent categories found.') }}</p>
                </div>
                @endif
            </div>
        </div>
