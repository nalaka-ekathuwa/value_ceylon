        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('Manufacturer/ Supplier') }}</label>
                        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-lg-3 col-from-label">{{translate('Product Specification / Special Features')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                        <div class="col-lg-9">
            ...
            <div class="card">
                ...
                <div class="card-body collapse show" id="collapse_2">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('Weight per unit') }}</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="weight_per_unit"  value="{{ $product->weight_per_unit }}" >
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('Export carton diamensions/ weight') }}</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="carton_dimensions" value="{{ $product->carton_dimensions }}" >
                        </div>
                    </div>
                    ...
                    <h6 class="mb-3" > {{translate('Shipping Configuration')}}</h6>
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('Shipping Terms') }}</label>
                        <div class="col-md-8">
                            <textarea name="shipping_terms" id="" cols="30" rows="4" class="form-control">{{ $product->shipping_terms }}</textarea>
                        </div>
                    </div>
