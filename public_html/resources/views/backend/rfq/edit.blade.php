...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.rfq.update', $rfq->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <select name="status" class="form-control" id="" required>
                            @forelse ($rfq_statuses as $rfq_status)
                                <option @selected($rfq_status->id == old($rfq->status)) value="{{ $rfq_status->id }}">
                                    {{ $rfq_status->name }}</option>
                            @empty
                                <option value=""></option>
                            @endforelse
