                ...
                <div class="bg-white px-sm-3">
                    <div class="aiz-carousel sm-gutters-17" data-items="8" data-xxl-items="8" data-xl-items="6"
                        ...
                        @foreach ($featured_categories as $key => $category)
                            ...
                            @endphp
                            <div
                                class="carousel-box position-relative text-center has-transition hov-scale-img hov-popup-shadow border-right border-top border-bottom @if ($key == 0) border-left @endif">
            ...
            <div class="container">
                ...
                <div class="aiz-carousel arrow-x-0 arrow-inactive-none" data-items="5" data-xxl-items="5"
                    ...
                    @foreach ($best_selers as $key => $seller)
                        @if ($seller->user != null)
                            <div
                                class="carousel-box h-100 position-relative text-center border-right border-top border-bottom @if ($key == 0) border-left @endif has-transition hov-popup-shadow">
